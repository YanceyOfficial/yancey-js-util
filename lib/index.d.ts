...
export declare const poll: <T>(fn: () => Promise<T>, checkHasDoneFn: (res: T) => boolean, timeout: number, interval: number) => Promise<unknown>;
export declare const downloadFile: (blob: string, fileName: string) => void;
